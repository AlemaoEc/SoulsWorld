function UnderworldEnemyProcessAttack(argument0, argument1) {
	// Start of the attack
	...
	var hits = instance_place_list(x,y,oDeadPlayer,hitByAttackNow, false);
	if (hits > 0)
	{
	...
	mask_index = sUnderworldEnemyIdle;
